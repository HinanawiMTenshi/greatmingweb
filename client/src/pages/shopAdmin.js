...
function ShopAdmin({ currentUser }) {
    ...
    const handleAddProduct = () => {
        // 发送 POST 请求以添加新商品
        axios.post('http://68.48.120.202:3000/products', newProduct)
            .then(response => {
                // 刷新商品列表
    ...
    const handleDeleteProduct = (productId) => {
        // 发送 DELETE 请求以删除商品
        axios.delete(`http://68.48.120.202:3000/products/${productId}`)
            .then(() => {
                // 刷新商品列表
    ...
    const handleEditProduct = () => {
        // 发送 PUT 请求以编辑商品
        axios.put(`http://68.48.120.202:3000/products/${editProduct.id}`, editProduct)
            .then(response => {
                // 刷新商品列表
